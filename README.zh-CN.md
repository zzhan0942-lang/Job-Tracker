...
![Job Tracker 控制台与数据可视化](./docs/images/job-tracker-dashboard-demo.png)

> ⚠️ 演示说明：本页面截图中的企业名称、岗位、求职状态、日期及统计数据均为 AI 生成的虚构演示内容，仅用于展示 Job Tracker 的界面与功能，不代表任何真实求职记录。

展示：

- 总记录、进行中岗位、测评 / 笔试、面试中和 Offer
- DDL / 待跟进
- 当前状态分布、每周投递趋势、Base 分布和流程转化率

### 最近进展与我的投递

![Job Tracker 最近进展与我的投递](./docs/images/job-tracker-applications-demo.png)
