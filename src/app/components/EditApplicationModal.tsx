  ...
  return (
    <>
      <button
        ...
        className="whitespace-nowrap rounded-full border border-neutral-200 bg-white px-4 py-2 text-sm transition hover:bg-neutral-100 dark:border-neutral-700 dark:bg-[#171719] dark:hover:bg-neutral-800"
      >
        编辑岗位
      </button>
