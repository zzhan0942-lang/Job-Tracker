    ...
    <>
      <div className="mt-4 flex flex-wrap gap-2">
        <button
          ...
          className="rounded-full border border-neutral-200 px-3.5 py-2 text-xs text-neutral-500 transition hover:bg-neutral-50 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800"
        >
          编辑
        </button>
        ...
        <button
          type="button"
          onClick={remove}
          className="rounded-full border border-red-100 px-3.5 py-2 text-xs text-red-400 transition hover:bg-red-50 dark:border-red-950 dark:text-red-300 dark:hover:bg-red-950/50"
        >
          删除
        </button>
      </div>
